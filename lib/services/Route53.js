...
Route53.prototype.getHostedZoneId = function (zoneName, callback) {
  ...
  function getHostedZoneId(zoneName, callback) {
  ...
  getHostedZoneId(zoneName, callback)
}

Route53.prototype.createRecord = function (zoneName, rr, callback) {
  var self = this;

  self.getHostedZoneId(zoneName, onGetHostedZoneId);

  function onGetHostedZoneId(hostedZoneId) {
