...
Route53.prototype.createRecord = function (zoneName, rr, callback) {
  ...
  this.r53.listHostedZonesByName(listHostedZonesParams, onListHostedZones);
  ...
  function onListHostedZones(err, data) {
    ...
    // Change record.
    this.r53.changeResourceRecordSets(rrParams, onChangeResourceRecordSet);
  };
...
Route53.prototype.getRecord = function (zoneName, rrName, rrType, callback) {
  ...
  function onListHostedZones(err, data) {
    ...
    console.log(data)
    // Get record.
    this.r53.listResourceRecordSets(params, onListResourceRecordSet);
  };
