...
/*
 * TODO: Some duplicative code shoudl be refactored in here.
 */
...
function createRecord(zoneName, rr, callback) {
  ...
  r53.listHostedZonesByName(listHostedZonesParams, onListHostedZones);
  ...
  function onListHostedZones(err, data) {
    ...
    // Change record.
    r53.changeResourceRecordSets(rrParams, onChangeResourceRecordSet);
  };
...
function deleteRecord(zoneName, rr, callback) {
  aws.config.region = 'us-east-1';
  var r53 = new aws.Route53();
...
function alterRecord(zoneName, rr, callback) {
  aws.config.region = 'us-east-1';
  var r53 = new aws.Route53();
...
function getRecord(zoneName, rrName, rrType, callback) {
  ...
  function onListHostedZones(err, data) {
    ...
    // Get record.
    r53.listResourceRecordSets(params, onListResourceRecordSet);
  };
